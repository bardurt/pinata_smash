...
import com.zygne.engine.implementation.Font;
import com.zygne.engine.implementation.GLGame;
import com.zygne.engine.implementation.SpriteBatcher;
import com.zygne.engine.implementation.Texture;
import com.zygne.engine.implementation.TextureRegion;
import com.zygne.engine.core.base.Music;
import com.zygne.engine.core.base.Sound;
...
public class Assets {
    ...
    public static void load(GLGame game) {
        ...
        ball1 = new TextureRegion(texturePinata, 0, 900, 522, 1148);
        ball2 = new TextureRegion(texturePinata, 522, 900, 522, 1148);
        ball3 = new TextureRegion(texturePinata, 1044, 900, 522, 1148);
