...
public class Particle implements com.zygne.engine.core.base.RenderableObject {

    public static final int STATE_ALIVE = 0;    // particle is alive
    public static final int STATE_DEAD = 1;        // particle is dead

    private static final int DEFAULT_LIFETIME = 45;    // play with this
    private static int MAX_DIMENSION = 8;    // the maximum width or height
    private static final int MAX_SPEED = 8;    // maximum speed (per update)
